...
Chakra's theming mechanism allow _global_ changes to all components (within an application), or to single component [variants](https://chakra-ui.com/docs/styled-system/component-style).
